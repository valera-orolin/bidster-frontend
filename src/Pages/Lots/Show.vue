...
<template>
    <AuthenticatedLayout>
        ...
        <div class="flex flex-col">
            ...
            <div class="flex flex-col space-y-4 mt-5 bg-my-gray2 rounded-2xl w-full lg:w-fit p-8 border-0.5 border-my-gray2 hover:border-my-lila transition duration-500 cursor-pointer lg:hover:-translate-y-1">
