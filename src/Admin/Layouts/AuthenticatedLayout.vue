    ...
    <div class="flex flex-col h-screen bg-my-black">
        ...
        <template v-if="auctionsPage">
            <div class="w-full bg-my-gray2 mt-24 md:mt-28 text-center">
                ...
                <AuctionsSearchForm v-if="showSearchForm" />
        ...
        <div v-bind:class="{'md:px-32 p-4 md:pb-16 bg-my-black flex-grow': true, 'md:pb-16 pt-24 md:pt-36': !headerText && !auctionsPage, 'pt-4 md:pt-16': headerText || auctionsPage}">
            <main>
                <slot />
            </main>
        </div>
